...
public class EnchantmentProtection extends Enchantment
{
     ...
     */
    public static int getFireTimeForEntity(Entity e, int ticks)
    {
        int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.fireProtection.effectId, e.getInventory());

        if (i > 0)
        {
            ticks -= MathHelper.floor_float((float)ticks * (float)i * 0.15F);
        }
